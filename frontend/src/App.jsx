    ...
    <main className="app-shell">
      <header className="topbar panel">
        <div className="brand-block">
          ...
          <p className="summary">
            First real source browsing flow: save one active source, test connectivity, scan its
            directory tree, browse persisted file metadata, and observe queued jobs through a
            minimal backend-driven job framework.
          </p>
        ...
        <div className="toolbar">
          ...
          <div className="toolbar-actions">
            ...
            <button
              ...
              onClick={() => {
                setSelectedSettingsSection("source");
          ...
          <aside className="panel preview-panel">
            <div className="panel-header">
              <div>
                ...
                <h2>Reserved surface</h2>
              </div>
              <button type="button" className="mini-button" disabled title="Not implemented yet">
                Details
              </button>
            </div>
            ...
            <div className="preview-card">
              <div className="preview-canvas">
                <span>Preview assets are out of scope in this step</span>
              </div>
