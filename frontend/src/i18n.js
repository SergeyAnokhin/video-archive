const messages = {
  en: {
    ...
    files: {
      ...
      generatedTune: "Tuning output",
      generatedTuneShort: "tune",
      generatedTest: "Test output",
      generatedTestShort: "test"
    },
    previewPanel: {
      kicker: "Preview",
    ...
    details: {
      ...
      move: "Move file",
      delete: "Delete file",
      generatedBlock: "Generated marker",
      generatedTune: "Generated by tuning",
      generatedTest: "Generated by test conversion",
      assignedTags: "Assigned tags",
    ...
    tune: {
      ...
      intro: "Tune one parameter per run. Each run creates separate outputs, never replaces the source file, and stays scoped to one video.",
      dimensionAxis: "Max side",
      dimensionAxisHint: "Sweep size only",
      qualityAxis: "CRF",
      qualityAxisHint: "Sweep quality only",
      codecAxis: "Codec",
      codecAxisHint: "Compare codec variants",
      rangeFrom: "From",
      rangeTo: "To",
      rangeStep: "Step",
      codecs: "Codecs to test",
      fixedDimension: "Fixed max side",
      fixedQuality: "Fixed CRF",
      fixedCodec: "Fixed codec",
      dropAudio: "Drop audio",
      ...
      noOutputsBody: "Run one sweep to compare variants for the selected parameter.",
      events: "Run events",
    ...
    messages: {
      ...
      fileMoved: "Moved {{name}} to {{path}}.",
      fileDeleted: "Deleted {{name}}.",
      movePrompt: "Move {{name}} to folder (relative to source root). Leave empty for the root folder.",
  ...
  ru: {
    ...
    files: {
      ...
      generatedTune: "Результат тюнинга",
      generatedTuneShort: "tune",
      generatedTest: "Тестовый файл",
      generatedTestShort: "test"
    },
    previewPanel: {
      kicker: "Превью",
    ...
    details: {
      ...
      move: "Переместить",
      delete: "Удалить",
      generatedBlock: "Происхождение",
      generatedTune: "Сгенерировано тюнингом",
      generatedTest: "Сгенерировано test-конвертацией",
    ...
    tune: {
      ...
      intro: "За один запуск тюнинг перебирает только один параметр. Результаты всегда сохраняются отдельно, исходный файл не заменяется.",
      dimensionAxis: "Макс. сторона",
      dimensionAxisHint: "Перебор только размера",
      qualityAxis: "CRF",
      qualityAxisHint: "Перебор только качества",
      codecAxis: "Кодек",
      codecAxisHint: "Сравнение вариантов кодека",
      rangeFrom: "От",
      rangeTo: "До",
      rangeStep: "Шаг",
      codecs: "Кодеки для прогона",
      fixedDimension: "Фикс. макс. сторона",
      fixedQuality: "Фикс. CRF",
      fixedCodec: "Фикс. кодек",
      dropAudio: "Убрать аудио",
      ...
      noOutputsBody: "Запустите один прогон, чтобы сравнить варианты по выбранному параметру.",
    ...
    messages: {
      ...
      fileMoved: "Файл {{name}} перемещён в {{path}}.",
      fileDeleted: "Файл {{name}} удалён.",
      movePrompt: "Переместить {{name}} в папку (относительно корня источника). Оставьте пусто, чтобы переместить в корень.",
      deleteConfirm: "Удалить {{name}} безвозвратно?"
    },
    status: {
...
Object.assign(messages.ru.header, {
  ...
  backendOk: "\u0411\u044d\u043a\u0435\u043d\u0434 \u043e\u043a\u0435\u0439",
  backendChecking: "\u041f\u0440\u043e\u0432\u0435\u0440\u043a\u0430 \u0431\u044d\u043a\u0435\u043d\u0434\u0430",
  backendOffline: "\u0411\u044d\u043a\u0435\u043d\u0434 \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u0435\u043d"
})
...
Object.assign(messages.en.details, {
  ...
  aspectRatio: "Aspect ratio",
  duration: "Duration",
  codecBlock: "Codec and stream",
  profileBlock: "Last conversion profile",
  ...
  container: "Container",
  targetResolution: "Target size",
  sourceResolution: "Source size",
  quality: "Quality",
  audioMode: "Audio",
  audioDropped: "Dropped",
  audioKept: "Kept",
  noProfile: "This file has not been converted with a saved profile yet."
})
...
Object.assign(messages.ru.details, {
  ...
  codecBlock: "\u041a\u043e\u0434\u0435\u043a \u0438 \u043f\u043e\u0442\u043e\u043a",
  profileBlock: "\u041f\u043e\u0441\u043b\u0435\u0434\u043d\u0438\u0439 \u043f\u0440\u043e\u0444\u0438\u043b\u044c \u043a\u043e\u043d\u0432\u0435\u0440\u0442\u0430\u0446\u0438\u0438",
  videoCodec: "\u0412\u0438\u0434\u0435\u043e\u043a\u043e\u0434\u0435\u043a",
  codecProfile: "\u041f\u0440\u043e\u0444\u0438\u043b\u044c \u043a\u043e\u0434\u0435\u043a\u0430",
  audioCodec: "\u0410\u0443\u0434\u0438\u043e\u043a\u043e\u0434\u0435\u043a",
  bitrate: "\u0411\u0438\u0442\u0440\u0435\u0439\u0442",
  frameRate: "FPS",
  pixelFormat: "\u041f\u0438\u043a\u0441\u0435\u043b\u044c\u043d\u044b\u0439 \u0444\u043e\u0440\u043c\u0430\u0442",
  container: "\u041a\u043e\u043d\u0442\u0435\u0439\u043d\u0435\u0440",
  targetResolution: "\u0426\u0435\u043b\u0435\u0432\u043e\u0439 \u0440\u0430\u0437\u043c\u0435\u0440",
  sourceResolution: "\u0418\u0441\u0445\u043e\u0434\u043d\u044b\u0439 \u0440\u0430\u0437\u043c\u0435\u0440",
  quality: "\u041a\u0430\u0447\u0435\u0441\u0442\u0432\u043e",
  audioMode: "\u0410\u0443\u0434\u0438\u043e",
  audioDropped: "\u0423\u0431\u0440\u0430\u043d\u043e",
  audioKept: "\u0421\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u043e",
  noProfile: "\u0424\u0430\u0439\u043b \u0435\u0449\u0451 \u043d\u0435 \u043a\u043e\u043d\u0432\u0435\u0440\u0442\u0438\u0440\u043e\u0432\u0430\u043b\u0441\u044f \u0441 \u0441\u043e\u0445\u0440\u0430\u043d\u0451\u043d\u043d\u044b\u043c \u043f\u0440\u043e\u0444\u0438\u043b\u0435\u043c."
})

Object.assign(messages.en.taggingSettings, {
  noProviders: "No provider entries saved yet"
})

Object.assign(messages.ru.taggingSettings, {
  noProviders: "\u041f\u043e\u043a\u0430 \u043d\u0435\u0442 \u0441\u043e\u0445\u0440\u0430\u043d\u0451\u043d\u043d\u044b\u0445 provider-\u0437\u0430\u043f\u0438\u0441\u0435\u0439"
})

Object.assign(messages.en.providerSettings, {
  add: "Add provider",
  remove: "Remove",
  moveUp: "Move up",
  moveDown: "Move down",
  ...
  entryPlaceholder: "Optional display name",
...
Object.assign(messages.ru.providerSettings, {
  ...
  entryPlaceholder: "\u041d\u0435\u043e\u0431\u044f\u0437\u0430\u0442\u0435\u043b\u044c\u043d\u043e\u0435 \u0438\u043c\u044f",
  unnamed: "\u0411\u0435\u0437 \u0438\u043c\u0435\u043d\u0438",
  disabledTag: "\u0432\u044b\u043a\u043b.",
  providerNames: {
    openrouter: "OpenRouter",
