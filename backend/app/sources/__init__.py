...
both the `local` protocol (plain filesystem, unchanged from earlier stages)
and the `smb` protocol added in Stage 7 (`smbclient`, the high-level module
bundled with the `smbprotocol` package fixed in Tech Stack).
"""
