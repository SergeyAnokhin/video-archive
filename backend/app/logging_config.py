...
# CPU/memory on an interval (see `app/resource_monitor.py`). Samples share
# `backend.log`/the console with everything else -- a leading emoji (see
# `_sample` in `app/resource_monitor.py`) is what makes them stand out
# visually rather than a separate file.
