...
- **Conversion** — saved ffmpeg profiles (codec, container, max dimension, CRF, drop-audio, optional Intel Quick Sync/QSV hardware encoding on Windows with automatic software fallback) with a safe-replace pipeline.
