...
| App-wide formatters, status labels, size/date formatting, and directory badges | [`../frontend/src/appFormatters.js`](../frontend/src/appFormatters.js) | [`../frontend/src/App.jsx`](../frontend/src/App.jsx), [`../frontend/src/components/`](../frontend/src/components/) |
...
| Unified library browser with folder cards, file cards, and subtree-status badges | [`../frontend/src/components/layout/FileBrowserPanel.jsx`](../frontend/src/components/layout/FileBrowserPanel.jsx) | [`../frontend/src/App.jsx`](../frontend/src/App.jsx), [`../backend/app/library_service.py`](../backend/app/library_service.py), [`../backend/app/main.py`](../backend/app/main.py) |
