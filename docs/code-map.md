...
| File list, folder-level actions, selected file entry point | [`../frontend/src/components/layout/FileBrowserPanel.jsx`](../frontend/src/components/layout/FileBrowserPanel.jsx) | [`../frontend/src/App.jsx`](../frontend/src/App.jsx), [`../backend/app/main.py`](../backend/app/main.py) |
| Right-side preview panel, preview/tag summary, preview settings entry point | [`../frontend/src/components/layout/LibraryPreviewPanel.jsx`](../frontend/src/components/layout/LibraryPreviewPanel.jsx) | [`../frontend/src/App.jsx`](../frontend/src/App.jsx), [`../backend/app/preview_service.py`](../backend/app/preview_service.py), [`../backend/app/tagging_service.py`](../backend/app/tagging_service.py) |
...
| File details / tune / jobs / logs modals | [`../frontend/src/components/modals/`](../frontend/src/components/modals/) | [`frontend-flows.md`](frontend-flows.md), [`../frontend/src/App.jsx`](../frontend/src/App.jsx) |
...
| preview settings UI or preview summary text | [`../backend/app/preview_service.py`](../backend/app/preview_service.py), [`frontend-flows.md`](frontend-flows.md) |
