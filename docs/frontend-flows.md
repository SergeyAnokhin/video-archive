...
| File-card preview flow: generated preview assets into main-grid thumbnails | [`../frontend/src/components/layout/FileBrowserPanel.jsx`](../frontend/src/components/layout/FileBrowserPanel.jsx) | [`../frontend/src/App.jsx`](../frontend/src/App.jsx), [`../backend/app/main.py`](../backend/app/main.py), [`../backend/app/preview_service.py`](../backend/app/preview_service.py) | Preview jobs update the matching file and folder cards, list cards use compact animated GIF assets, detail modals keep the JPEG collage, and previews load on both desktop and mobile widths. |
